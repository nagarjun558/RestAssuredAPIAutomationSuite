...
public class TC003_Post_Employee_Record extends TestBase{
	...
	void checkResposeBody()
	{
		...
		logger.info("Response from API=====>"+responseBody);
	...
	{
		String contentEncoding = response.header("Access-Control-Expose-Headers");
		Assert.assertEquals(contentEncoding, "Content-Type, X-Requested-With, X-authentication, X-client");
